...
\033[1;32;40m
\tTool Information :
\t❖ Tool Name : Grabber V.1.0 [Priv]
\t❖ Description : Grabber Free
\t❖ NOTE : Dilarang Menjual Grabber

\n\t 1.] Get Registered Data\n\t 2.] Mass Grabbing Site By Date\n
\033[0;37;40m
"""
registered=[]
domain=[]
...
if int(pilih) == 1:
 ...
 grabber()
 print("\n\033[92mGot  "+str(len(domain))+" Domain from - saved: AanGanteng.txt\033[0m")
else:
